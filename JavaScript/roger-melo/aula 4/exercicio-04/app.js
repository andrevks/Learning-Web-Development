...
let isMoreThan39Char = String(typeSentence.length > 39)
isMoreThan39Char = isMoreThan39Char[0].toUpperCase() + isMoreThan39Char.slice(1)
// console.log(
//   `A string que a "typeSentence" armazena tem mais de 39 caracteres? ${isMoreThan39Char}.`
//   )
...
/*
Como o null se torna zero em operações matemáticas, o valor final é 1.
Depois na conversão, foi true pois 1 não é um dos 8 valores falsy.
*/
...
isAgesSumLessOrEqualTo92 = agesSum <= 92
// console.log(
//   `A soma entre o 1º e o 3º item de "ages" é menor ou igual a 92. Essa afirmação é: ${isAgesSumLessOrEqualTo92}.`
//   )
