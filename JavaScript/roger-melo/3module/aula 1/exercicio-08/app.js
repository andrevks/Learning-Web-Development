...
const division = function(num1=2, num2=2){
    return num1 / num2
}
...
const upperCaseWords = function(words=[]){
  let newWords = []
...
// console.log(
// `O array "randomNumbers" possui ${numbersAmount} números, sendo ${positiveNumbersAmount}
// positivos e ${negativeNumbersAmount} negativos.`
// )
