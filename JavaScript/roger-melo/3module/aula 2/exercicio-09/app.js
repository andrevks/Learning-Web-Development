...
// console.log(convertToString('Ethereum'))
...
// console.log(howManyCharacters('Solana'))
...
const  toLowerCaseString = (sentence) =>{
...
const getIndexOfCaracter = (caracter, sentence) => {
  return sentence.indexOf(caracter)
}

// console.log(getIndexOfCaracter('i','bitcoin'))
...
// console.log(isItemInArray('ethereum', coins))
...
const defi = ['Terra', 'Avalanche', 'Wrapped Bitcoin']

// console.log(concatArray(coins, defi))
/*
  07
...
// console.log(removeLastItem(defi))
