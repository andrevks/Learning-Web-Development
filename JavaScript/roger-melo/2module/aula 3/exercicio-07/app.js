...
/*
  ...
  - Abaixo do array "animals", verifique se o animal "leão" **não** existe no  
    array. Se não existir, exiba no console a mensagem 
    "Leão não existe no array animals.";
  - Se existir, exiba no console a mensagem "Existe um leão no array animals.".
*/

const animals = ['macaco', 'tucano', 'elefante', 'pavão', 'hipopótamo']
const isLion = animals.includes('leão')
// if(!isLion){
...
switch(drinkType){
  case 'água':
    drinkInfo = "Substância química cujas moléculas são formadas por dois átomos "+
                  "de hidrogênio e um de oxigênio."
    break;
  case 'refrigerante':
    drinkInfo = "Bebida não alcoólica e não fermentada, fabricada industrialmente, "+
                "à base de água mineral e açúcar." 
    break;
  case 'suco':
    drinkInfo = "Bebida produzida do líquido extraído de frutos."
    break;
  default:
    drinkInfo = "Bebida desconhecida."
}
